package com.weixigu.boardgame.domain;
...
public class TicTacToe implements Serializable {
    ...
    /**
     * A field (no matter it's declared in the @Entity class or not) will be included in JSON if it has a setter/getter.
     * AccessLevel.NONE stops Lombok from generating the getter getXNext(), which includes 'xnext' in the JSON.
     */
